...
public final class AtomicIOServerConstant {
    ...
    public static final String KICK_OUT_CHANNEL_PREFIX_NAME = PREFIX + "kickout-channel:"; // 踢出通知频道名前缀 （格式：atomicio:kickout:nodeId）
    ...
    public static final String USER_NODES_KEY = PREFIX + "stats:user_nodes"; //用户到集群到映射
