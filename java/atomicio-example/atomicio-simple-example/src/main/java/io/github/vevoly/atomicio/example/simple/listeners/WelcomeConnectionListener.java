...
public class WelcomeConnectionListener implements ConnectEventListener {
    ...
    private String buildWelcomeMenu() {
        ...
        sb.append("  [Login]       1:101:deviceId:user1:any-token\n");
        sb.append("                (cmd=101, payload='userId:token')\n");
        sb.append("\n");
        sb.append("  --- Group Management ---\n");
        sb.append("  [Join Group]  2:201:deviceId:public-group\n");
        sb.append("                (cmd=201, payload='groupId')\n");
        sb.append("\n");
        sb.append("  --- Messaging (Framework Routing) ---\n");
        sb.append("  [Send P2P]    3:501:deviceId:user2|2001|Hello there!\n");
        sb.append("                (cmd=501, payload='toUserId|bizType|bizPayload')\n");
        sb.append("\n");
        sb.append("  [Send Group]  4:502:deviceId:public-group||3005|Hello group!\n");
